...
trackingSHFolder = r'D:\\Movies\\GroupedData\\Groups\\WT_B0_30min_test\\'
...
for i,trackingFile in enumerate(trackingList):
    ...
    AnalysisFolder=wDir+'\\Analysis' + inSuff + '\\'
    thisFishDictName=AnalysisFolder+name+'_ANALYSIS' + inSuff + '.npy'
